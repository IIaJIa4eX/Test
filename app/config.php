...
class config {
    ...
    public function getAll($defaultValue = []) {
        if ($this->currentConfig == "")
            return $defaultValue;
        ...
        return $this->allConfigs[$this->currentConfig];
    }
    ...
    public function del($key) {
        ...
        foreach ($this->allConfigs[$this->currentConfig] as $k => $v) {
            if ($k == $key) continue;
            $arr[$k] = $v;
        }

        $this->allConfigs[$this->currentConfig] = $arr;
    }
}