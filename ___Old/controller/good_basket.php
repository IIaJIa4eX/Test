...
class good_basket extends ControllerBase {
    ...
    public function updateCount(){
        ...
        $this->db->create("UPDATE `good_basket` SET `count` = :count WHERE `good_basket`.`id` = :id", ["id" => $id, "count" => $count]);

        // return $this->index();
        // return $this->Render()->WriteJSON(rand());
        // echo rand();

        echo $this->countOrderF();
        die();

    }

    public function countOrderF(){
        $curUser = app::Current()->getUser();
